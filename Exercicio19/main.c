...
int main()
{
    ...
    char nome[40], sexo;
    int alunos_tot, alunos_apr_d, alunos_rep_d, alunos_p5, alunos_apr_p5, alunos_rep_p5, alunos_2e, alunos_apr_2e, alunos_rep_2e, alunos_apr, alunos_rep;
    float n1, n2, n3, n4, n5, med;
    alunos_tot=alunos_apr_d=alunos_rep_d=alunos_p5=alunos_apr_p5=alunos_rep_p5=alunos_2e=alunos_apr_2e=alunos_rep_2e=alunos_apr=alunos_rep=0;
