...
int main()
{
    ...
    char nome[40], sexo;
    int alunos_tot, alunos_apr_d, alunos_rep_d, alunos_p5, alunos_apr_p5, alunos_rep_p5, alunos_2e, alunos_apr_2e, alunos_rep_2e, alunos_apr, alunos_rep, masc, femi;
    float n1, n2, n3, n4, n5, med;
    alunos_tot=alunos_apr_d=alunos_rep_d=alunos_p5=alunos_apr_p5=alunos_rep_p5=alunos_2e=alunos_apr_2e=alunos_rep_2e=alunos_apr=alunos_rep=masc=femi=0;
    ...
    while(sexo!='x' && sexo!='X'){
        ...
        while(sexo!='x' && sexo!='X'){
            if(sexo=='m'||sexo=='M')
            masc++;//Mais um aluno masculino
            else if(sexo=='f'||sexo=='F')
            femi++;//Mais uma aluna feminina
    ...
    printf("%d alunas femininas no total\n", femi);
    printf("%d alunos masculinos no total\n", masc);
